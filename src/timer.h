...
TIMER_EXTERN	void notify_timer_start(void);
TIMER_EXTERN	void period_timer_start(void);
TIMER_EXTERN	void pwm_timer_start(void);

TIMER_EXTERN	void system_timer_stop(void);
TIMER_EXTERN	void notify_timer_stop(void);
TIMER_EXTERN	void period_timer_stop(void);
TIMER_EXTERN	void pwm_timer_stop(void);

TIMER_EXTERN	void notify_timer_init(void);
